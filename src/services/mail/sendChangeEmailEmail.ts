...
const recoverPassword = async (userData: UserData, token:string) => {
  try {
                                ...
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;" align="left">
                                    ...
                                    <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">Haz solicitado cambiar la cuenta de Email con la que inicias sesi&oacute;n en <span style="color: #39b94a; font-size: 16px; line-height: 22.4px;">EntGamers</span>, el
                                        ultimo paso a seguir es confirmar tu nueva cuenta de correo haciendo clic al bot&oacute;n.</span>
                                      </p>
                                      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">Este link ser&aacute; valido por 2 horas a partir de su expedici&oacute;n.</span></p>
                                      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">Si no ha solicitado este correo ign&oacute;relo.</span></p>
                                    </div>
                              ...
                              <tbody>
                                <tr>
                                  <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;" align="left">
                                    ...
                                    <div align="center">
                                      <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Open Sans',sans-serif;"><tr><td style="font-family:'Open Sans',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${FRONTEND_URL}/change-email?${token}" style="height:51px; v-text-anchor:middle; width:234px;" arcsize="8%" stroke="f" fillcolor="#39b94a"><w:anchorlock/><center style="color:#010206;font-family:'Open Sans',sans-serif;"><![endif]-->
                                      <a href="${FRONTEND_URL}/change-email?${token}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #010206; background-color: #39b94a; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                        <span style="display:block;padding:16px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px; font-family: 'Open Sans', sans-serif;">Confirmar cambio de Email</span></span>
                                      </a>
    ...
    throw new ApiError(400, 'Bad Request', 'Error sending recover password email')
  }
}
